...
class MagicWordCategory:
    def __init__(self, name, defaultAccess=700):
        self.name = name
        self.defaultAccess = defaultAccess

CATEGORY_UNKNOWN = MagicWordCategory('Unknown')
CATEGORY_USER = MagicWordCategory('Default Player', defaultAccess=100)
...
CATEGORY_MODERATION = MagicWordCategory('Moderation', defaultAccess=350)
...
CATEGORY_GOD = MagicWordCategory('God', defaultAccess=800)
