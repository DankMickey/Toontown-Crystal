...
class ToontownLoadingScreen:
    ...
    def begin(self, range, label, gui, tipCategory, zoneId):
        ...
        self.zone2fontcolor = {
            ...
            ToontownGlobals.DonaldsDreamland : VBase4(0.6, 0.9090909090909091, 0.8, 1.0),
            ToontownGlobals.LullabyLane : VBase4(0.6, 0.9090909090909091, 0.8, 1.0),
            ToontownGlobals.PajamaPlace : VBase4(0.6, 0.9090909090909091, 0.8, 1.0),
            ToontownGlobals.OutdoorZone : VBase4(0.6, 0.9090909090909091, 0.8, 1.0),
