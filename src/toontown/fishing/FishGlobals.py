...
RodRarityFactor = {0: 1.0 / (GlobalRarityDialBase * 1),
 1: 1.0 / (GlobalRarityDialBase * 0.86),
 2: 1.0 / (GlobalRarityDialBase * 0.84),
 3: 1.0 / (GlobalRarityDialBase * 0.82),
 4: 1.0 / (GlobalRarityDialBase * 0.75)}
MaxRodId = 4
MaxTank = 100
...
__fishDict = {0: ((1,
     ...
     (3,
      5,
      2,
      (TTG.SillyStreet, TTG.CrystalGarden)),
     (1,
      5,
      1,
 ...
 2: ((2,
      6,
      1,
      (TTG.CrystalGarden, Anywhere)),
     (2,
      6,
      6,
      (TTG.ElmStreet, TTG.CrystalGarden)),
     (5,
      11,
      3,
      (TTG.LullabyLane,)),
     (2,
      6,
      2,
      (TTG.CrystalGarden, TTG.MyEstate, TTG.OutdoorZone)),
     (5,
      11,
      1,
      (TTG.Dreamland, TTG.MyEstate, TTG.OutdoorZone))),
 4: ((2,
      8,
      1,
      (TTG.ToontownCentral, Anywhere)),
     ...
     (2,
      8,
      5,
      (TTG.ToontownCentral, TTG.Melodyland))),
 6: ((8,
      12,
      1,
      (TTG.TheBrrrgh,)),),
 ...
 12: ((7,
       15,
       1,
       (TTG.CrystalDock, Anywhere)),
      (18,
       20,
       5,
       (TTG.CrystalDock, TTG.MyEstate, TTG.OutdoorZone)),
      (1,
       5,
       4,
       (TTG.CrystalDock, TTG.MyEstate, TTG.OutdoorZone)),
 ...
 14: ((2,
       6,
       1,
       (TTG.CrystalGarden, TTG.MyEstate, TTG.OutdoorZone, Anywhere)), (2,
       6,
       2,
       (TTG.CrystalGarden, TTG.MyEstate, TTG.OutdoorZone))),
 16: ((4,
       12,
       4,
       (TTG.Melodyland, Anywhere)), (4,
       12,
       6,
       (TTG.BaritoneBoulevard, TTG.Melodyland)), (4,
       12,
       6,
       (TTG.TenorTerrace, TTG.Melodyland))),
 18: ((2,
       4,
       2,
       (TTG.CrystalDock, Anywhere)), (5,
       8,
       6,
       (TTG.TheBrrrgh,)), (4,
       6,
 ...
 20: ((4,
      ...
      (10,
       14,
       3,
       (TTG.Dreamland, TTG.CrystalGarden))),
 22: ((12,
       16,
       2,
       (TTG.MyEstate, TTG.OutdoorZone, TTG.CrystalGarden, Anywhere)),
      (14,
       18,
       2,
       (TTG.MyEstate, TTG.OutdoorZone, TTG.CrystalGarden, Anywhere)),
      (14,
       20,
       4,
       (TTG.MyEstate, TTG.OutdoorZone, TTG.CrystalGarden)),
      (14,
       20,
       6,
       (TTG.MyEstate, TTG.OutdoorZone, TTG.CrystalGarden))),
 24: ((9,
      ...
      (8,
       12,
       4,
       (TTG.CrystalGarden, TTG.CrystalDock)),
      (8,
       12,
       5,
       (TTG.CrystalGarden, TTG.CrystalDock)),
 ...
 28: ((2,
       10,
       2,
       (TTG.CrystalDock, Anywhere)), (4,
       10,
       5,
       (TTG.BarnacleBoulevard, TTG.CrystalDock)), (4,
       10,
       6,
       (TTG.SeaweedStreet, TTG.CrystalDock))),
 30: ((13,
       17,
       4,
       (TTG.Melodyland, Anywhere)),
 ...
 32: ((1,
      ...
      (1,
       5,
       7,
       (TTG.TheBrrrgh, TTG.Dreamland))),
 34: ((1,
       20,
       7,
       (TTG.Dreamland, Anywhere)),)}
