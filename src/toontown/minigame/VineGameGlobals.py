...
CourseWeights = {ToontownGlobals.ToontownCentral: ((0, 25),
                                   ...
                                   (2, 25),
                                   (3, 25)),
 ToontownGlobals.CrystalDock: ((1, 25),
                               (2, 25),
                               (3, 25),
                               (4, 25)),
 ToontownGlobals.CrystalGarden: ((2, 25),
                                (3, 25),
                                (4, 25),
                                (5, 25)),
 ToontownGlobals.Dreamland: ((3, 25),
                                     (4, 25),
                                     (5, 25),
                                     (6, 25)),
 ToontownGlobals.TheBrrrgh: ((4, 25),
                             ...
                             (6, 25),
                             (7, 25)),
 ToontownGlobals.Dreamland: ((4, 20),
                                    (5, 20),
                                    (6, 20),
                                    (7, 20),
                                    (8, 20))}
BaseBonusOnEndVine = {ToontownGlobals.ToontownCentral: 4,
 ...
 ToontownGlobals.Dreamland: 7,
 ToontownGlobals.TheBrrrgh: 8,
 ToontownGlobals.Dreamland: 9}
BatInfo = {ToontownGlobals.ToontownCentral: ((60, 0, 0.35),),
 ToontownGlobals.CrystalDock: ((60, 0, 0.25), (30, 30)),
 ToontownGlobals.CrystalGarden: ((60, 0, 0.25), (15, 30)),
 ToontownGlobals.Dreamland: ((60, 0, 0.25), (10, 25)),
 ToontownGlobals.TheBrrrgh: ((60, 0, 0.25), (30, 30), (30, 20)),
 ToontownGlobals.Dreamland: ((60, 0, 0.25), (30, 30), (10, 20))}
SpiderLimits = {ToontownGlobals.ToontownCentral: 1,
 ToontownGlobals.CrystalDock: 2,
 ToontownGlobals.CrystalGarden: 2,
 ToontownGlobals.Dreamland: 3,
