...
GameDuration = {ToontownGlobals.ToontownCentral: 150,
 ToontownGlobals.CrystalDock: 145,
 ToontownGlobals.CrystalGarden: 140,
 ToontownGlobals.Melodyland: 135,
 ToontownGlobals.TheBrrrgh: 130,
 ToontownGlobals.Dreamland: 125}
BaseBonusOnCompletion = {ToontownGlobals.ToontownCentral: 15,
 ToontownGlobals.CrystalDock: 17,
 ToontownGlobals.CrystalGarden: 19,
 ToontownGlobals.Melodyland: 21,
 ToontownGlobals.TheBrrrgh: 23,
 ToontownGlobals.Dreamland: 25}
...
ScoreLossPerFallDown = {ToontownGlobals.ToontownCentral: -0,
 ToontownGlobals.CrystalDock: -0,
 ToontownGlobals.CrystalGarden: -0,
 ToontownGlobals.Melodyland: -0,
 ToontownGlobals.TheBrrrgh: -0,
 ToontownGlobals.Dreamland: -0}
...
SectionWeights = {ToontownGlobals.ToontownCentral: ((0, 25),
                                   ...
                                   (4, 10),
                                   (5, 0)),
 ToontownGlobals.CrystalDock: ((0, 15),
                               (1, 25),
                               (2, 25),
                               (3, 15),
                               (4, 10),
                               (5, 10)),
 ToontownGlobals.CrystalGarden: ((0, 15),
                                (1, 15),
                                (2, 25),
                                (3, 25),
                                (4, 10),
                                (5, 10)),
 ToontownGlobals.Melodyland: ((0, 10),
                                     (1, 10),
                                     (2, 25),
                                     (3, 25),
                                     (4, 15),
 ...
 ToontownGlobals.TheBrrrgh: ((0, 10),
                             ...
                             (4, 25),
                             (5, 15)),
 ToontownGlobals.Dreamland: ((0, 10),
                                    (1, 10),
                                    (2, 15),
                                    (3, 15),
                                    (4, 25),
...
NumSections = {ToontownGlobals.ToontownCentral: 5,
 ToontownGlobals.CrystalDock: 5,
 ToontownGlobals.CrystalGarden: 5,
 ToontownGlobals.Melodyland: 5,
 ToontownGlobals.TheBrrrgh: 5,
 ToontownGlobals.Dreamland: 5}
PercentMaxEnemies = {ToontownGlobals.ToontownCentral: 50,
 ToontownGlobals.CrystalDock: 60,
 ToontownGlobals.CrystalGarden: 70,
 ToontownGlobals.Melodyland: 80,
 ToontownGlobals.TheBrrrgh: 90,
 ToontownGlobals.Dreamland: 100}
PercentMaxTreasures = {ToontownGlobals.ToontownCentral: 100,
 ToontownGlobals.CrystalDock: 100,
 ToontownGlobals.CrystalGarden: 100,
 ToontownGlobals.Melodyland: 100,
 ToontownGlobals.TheBrrrgh: 100,
 ToontownGlobals.Dreamland: 100}
PercentMaxSpawnPoints = {ToontownGlobals.ToontownCentral: 100,
 ToontownGlobals.CrystalDock: 90,
 ToontownGlobals.CrystalGarden: 80,
 ToontownGlobals.Melodyland: 70,
 ToontownGlobals.TheBrrrgh: 60,
 ToontownGlobals.Dreamland: 50}
