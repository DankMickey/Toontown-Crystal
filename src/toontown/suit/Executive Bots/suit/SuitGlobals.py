...
ColdCallerHead = VBase4(0.25, 0.35, 1.0, 1.0) # Head used by Cold Caller
            ...
            # Exebots
suitProperties = {'cc': (3.5 / cSize, VBase4(0.55, 0.65, 1.0, 1.0), ['coldcaller'], '', 4.63),
                  ...
                  'pm': (4.75 / bSize, SuitDNA.salesPolyColor, ['movershaker'], '', 6.7),
                  'hd': (6.5 / aSize, SuitDNA.corpPolyColor, ['headhunter'], '', 7.45),
                  'bg': (6.75 / cSize, VBase4(0.85, 0.55, 0.55, 1.0), ['flunky'], 'corporate-raider.jpg', 8.23),
                  'c': (7.0 / aSize, SuitDNA.salesPolyColor, ['yesman'], '', 8.95),
                  # Bossbots
