...
LanguageButtonText = 'Packs'
PackSelectorTitle = 'Choose your pack!'
PackSelectorCurrent = 'Current packs: %s'
PackSelectorAvailable = 'Available packs:'
PackSelectorBack = 'Back'
PackSelectorConfirm = 'Are you sure you want to change your content pack to %s? This will restart your game.'
PackSelectorSameLanguage = "You're already using that content pack!"
CogLevelLabelOn = 'The cog level GUI is on.'
CogLevelLabelOff = 'The cog level GUI is off.'

HouseNames = ("Jungle", "Tiki", "Fort", "Sand Castle", "Cupcake", "Woods")
